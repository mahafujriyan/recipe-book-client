...
//   const navLinks = (
//     <>
//       <NavLink to="/" className={({ isActive }) => isActive ? 'text-orange-600 font-bold' : ''}>Home</NavLink>
//       <NavLink to="/allRecipe" className={({ isActive }) => isActive ? 'text-orange-600 font-bold' : ''}>All Recipe</NavLink>
...
//   const userLinks = (
//     <>
//       <NavLink to="/addRecipe" className={({ isActive }) => isActive ? 'text-orange-600 font-bold' : ''}>Add Recipe</NavLink>
//       <NavLink to="/myRecipe" className={({ isActive }) => isActive ? 'text-orange-600 font-bold' : ''}>My Recipes</NavLink>
//       <NavLink to="/dashboard" className={({ isActive }) => isActive ? 'text-orange-600 font-bold' : ''}>
...
//         {/* Logo */}
//         <Link to="/" className="flex items-center gap-2 text-3xl font-bold text-rose-600 hover:text-rose-800 transition-all duration-200">
//           <GiOpenBook className="text-4xl" />
//           <span>TastyPages</span>
//         </Link>

//         {/* Mobile Hamburger */}
//         <div className="md:hidden text-2xl text-rose-700" onClick={handleMobileToggle}>
...
//               alt="avatar"
//               className="hidden md:block w-10 h-10 rounded-full cursor-pointer border-2 border-orange-500"
//             />
//             {showMenu && (
//               <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-md p-3 z-50">
//                 <img
...
//             <Link to="/signIn" className="btn bg-orange-400 hover:bg-orange-500 text-white px-4 py-1 rounded">Login</Link>
//             <Link to="/signUp" className="btn bg-orange-400 hover:bg-orange-500 text-white px-4 py-1 rounded">Register</Link>
//           </div>
//         )}
//       </div>
...
//             {!user ? (
//               <>
//                 <Link to="/signIn" onClick={handleMobileToggle} className="btn bg-orange-400 hover:bg-orange-500 text-white px-3 py-1 rounded">Login</Link>
//                 <Link to="/signUp" onClick={handleMobileToggle} className="btn bg-orange-400 hover:bg-orange-500 text-white px-3 py-1 rounded">Register</Link>
//               </>
//             ) : (
//               <div className="flex flex-col items-center gap-2 mt-4 p-3 border rounded bg-white shadow-md">
//                 <img
//                   src={user?.photoURL || 'https://i.ibb.co/ZYW3VTp/brown-brim.png'}
//                   alt={user.displayName}
//                   className="w-12 h-12 rounded-full border-2 border-orange-500 "
//                 />
//                 <p className="text-center font-semibold text-gray-700">{user?.displayName || 'User'}</p>
//                 <button
//                   onClick={() => {
//                     handleLogout();
//                     setMobileMenu(false);
